...
> [AIit](https://github.com/techkoala/AIit) 是一个**简洁**、**优雅**且**高效**的 [Hugo](https://gohugo.io/) 博客主题。

它的原型基于 [LoveIt 主题](https://github.com/dillonzq/LoveIt), [LeaveIt 主题](https://github.com/liuzc/LeaveIt), [KeepIt 主题](https://github.com/Fastbyte01/KeepIt) 和 [DoIt主题](https://github.com/HEIGE-PCloud/DoIt)。

AIit 主题继承了这些主题的优秀功能，并在此基础上在 **AI** 的辅助下添加了新的功能与优化。

AIit 主题的目标是创建一个功能强大且易于使用的 Hugo 主题，您可以全心关注于创作博客内容，而无需担心复杂的技术细节，just** do it**。
...
如果你现在正在使用 LoveIt 主题，你可以很容易地迁移至 AIit。

你可以将这个主题仓库添加为你的网站目录的子模块。

```bash
git submodule add https://github.com/techkoala/AIit.git themes/AIit
```
...
或者，你可以下载主题的[最新版本.zip 文件](https://github.com/techkoala/AIit/releases)并且解压放到`themes`目录。（不推荐，这个主题会被频繁更新，发行版中可能包含过时的文件。）

接着，前往 `config.toml` 并将默认主题更改为 `AIit`。
...
AIit 主题增加了许多新的功能与配置项，查看[变更日志](https://github.com/techkoala/DoIt/blob/main/CHANGELOG.md)与[文档](https://hugodoit.pages.dev/)来了解更多。

## 主题[预览](https://hugodoit.pages.dev/zh-cn/)

为了直观地浏览主题特性，这里有一个基于 **AIit** 主题渲染的 [预览网站](https://hugodoit.pages.dev/zh-cn/)。
...
所以，如果你更偏好 AIit 主题的设计语言和自由度，如果你想便捷地使用扩展的 Font Awesome 图标，如果你想在文章内嵌数学公式、流程图、音乐或是 Bilibili 视频，
那么，DoIt 主题可能是更适合你。
...
* 罗马尼亚语
* 越南语
* [贡献一种新的语言](https://github.com/techkoala/AIit/pulls)

[语言兼容性](https://hugodoit.pages.dev/zh-cn/theme-documentation-basics/#language-compatibility)

## [路线图](https://github.com/techkoala/AIit/projects/1)

## [变更日志](https://github.com/techkoala/AIit/blob/main/CHANGELOG.md)

## 问题、想法、 bugs 和 PRs

所有的反馈都是欢迎的！详见 [issue tracker](https://github.com/techkoala/AIit/issues)。

## 许可协议

AIit 根据 **MIT** 许可协议授权。 更多信息请查看 [LICENSE 文件](https://github.com/techkoala/AIit/blob/master/LICENSE)。

AIit 主题中用到了以下项目，感谢它们的作者：
